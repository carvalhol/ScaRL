...
declare -a INITIAL_SIZE=(100.0 130.0 150.0 190.0 310.0 380.0 540.0 550.0 600.0 700.0) #DIMENSIONED FOR ONE OK THEN  THEN SECOND FAIL
folder_prefix="MAX"
queue="haswellq"
...
size_increment=58.5 #SO WE HAVE THE SAME VALUES THAT FOR WEAK SCALING
...
declare -a INITIAL_SIZE=(63.75 122.25 180.75 239.25 297.75 356.25 414.75 473.25) #Sizes OK and power of two
folder_prefix="WEAK"
queue="haswellq"
mem_per_proc_mb=2500
walltime="01:00:00"
...
for ((pp = 0; pp < N; pp++)); do
    ...
    nmem_float=$(echo "$mem_per_proc_mb * $npt / $ns"  | bc) #TODO MAKE IT A FLOAT
    nmem=${nmem_float%.*}
    printf "nPROCS     =$np\n"
    printf "nSELECT    =$ns\n"
    ...
    printf "echo nPROCS   =$npt  INITIAL_SIZE = $init_size\n" >> $run_f
