...
model_folder="./MODEL"
this_folder="/workdir/carvalho/RF_Test/BIG_TEST/AUTOTESTS"
...
declare -a INITIAL_SIZE=(110 140 160 200 320 390 540 580 760 860) #DIMENSIONED FOR ONE FAIL THEN SECOND OK
size_decrease=10
